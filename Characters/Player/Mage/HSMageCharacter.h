/**
 * @file HSMageCharacter.h
 * @brief 마법사 캐릭터 클래스 정의
 ...
 * @enum EMagicType
 * @brief 마법 공격 타입 열거형
 * @details 마법사가 사용할 수 있는 마법 원소 타입들을 정의
 */
UENUM(BlueprintType)
enum class EMagicType : uint8
{
    Fire        UMETA(DisplayName = "Fire"),        ///< 화염 마법
    Ice         UMETA(DisplayName = "Ice"),         ///< 빙결 마법
    Lightning   UMETA(DisplayName = "Lightning"),   ///< 번개 마법
    Arcane      UMETA(DisplayName = "Arcane")       ///< 비전 마법
};

/**
 * @enum EMageSkillType
 * @brief 마법사 스킬 타입 열거형
 * @details 마법사 캐릭터가 사용할 수 있는 스킬들을 정의
 */
UENUM(BlueprintType)
